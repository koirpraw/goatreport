...
class ChartJsonDataSource extends StatefulWidget {
  const ChartJsonDataSource({Key? key}) : super(key: key);

  @override
  State<ChartJsonDataSource> createState() => _ChartJsonDataSourceState();
}

class _ChartJsonDataSourceState extends State<ChartJsonDataSource> {
  ...
  Future<String> _loadSalesDataAsset() async {
    return rootBundle.loadString('assets/raw/chart2.json');
  }
