...
class WaterLevelTracker extends StatefulWidget {
  WaterLevelTracker({Key? key}) : super(key: key);

  @override
  State<WaterLevelTracker> createState() => _WaterLevelTrackerState();
}

class _WaterLevelTrackerState extends State<WaterLevelTracker> {
  double _level = 150;
